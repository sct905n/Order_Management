...
class Cuaso:
    ...
    def hienthi(self):
        ...
        #hiển thị tên
        self.labelchinh = Label(self.cuaso,bd = 15, font = ('Arial Bold', 30), text = 'Quản lý nhà hàng')
        ...
        self.monchinh = Label(self.khung_trai, font = ('Arial Bold', 20), text = 'Món ăn chính', bd = 10)
        self.monchinh.grid(row = 0, column = 0)
        self.bang_gia_mon_chinh = Label(self.khung_trai, font = ('Arial Bold', 20), text = 'Giá', bd = 10)
        self.bang_gia_mon_chinh.grid(row = 0, column = 1)
        self.so_luong_mon_chinh = Label(self.khung_trai, font = ('Arial Bold', 20), text = 'Số lượng', bd = 10)
        self.so_luong_mon_chinh.grid(row = 0, column = 2)
        

        self.drink = Label(self.khung_phai, font = ('Arial Bold', 20), text = 'Đồ uống', bd = 10)
        self.drink.grid(row = 0, column = 0)
        self.bang_gia_do_uong = Label(self.khung_phai, font = ('Arial Bold', 20), text = 'Giá', bd = 10)
        self.bang_gia_do_uong.grid(row = 0, column = 1)
        self.so_luong_do_uong = Label(self.khung_phai, font = ('Arial Bold', 20), text = 'Số lượng', bd = 10)
        self.so_luong_do_uong.grid(row = 0, column = 2)
        

        self.dessert = Label(self.khung_giuatren, font = ('Arial Bold', 20), text = 'Món tráng miệng', bd = 10)
        self.dessert.grid(row = 0, column = 0)
        self.bang_gia_trang_mieng = Label(self.khung_giuatren, font = ('Arial Bold', 20), text = 'Giá', bd = 10)
        self.bang_gia_trang_mieng.grid(row = 0, column = 1)
        self.bang_gia_trang_mieng = Label(self.khung_giuatren, font = ('Arial Bold', 20), text = 'Số lượng', bd = 10)
        self.bang_gia_trang_mieng.grid(row = 0, column = 2)

        self.thanhtoan = Label(self.khung_giuaduoi, font = ('Arial Bold', 20), text = 'Thanh Toán', bd = 10)
...
#----------------------XỬ LÍ THANH TOÁN - KHUNG GIỮA BÊN DƯỚI-----------------------
        ...
        self.nut_tongtien = Button(self.khung_giuaduoi, font = ('Arial Bold', 16), width = 10, text = 'TỔNG TIỀN', command = self.tongtien, bd = 6)
        ...
        self.nut_hoadon = Button(self.khung_giuaduoi, font = ('Arial Bold', 16), width = 10, text = 'IN HÓA ĐƠN', command = self.Hoadon, bd = 6)
...
#-------------XỬ LÍ NÚT ẤN KHUNG GIỮA BÊN DƯỚI---------------
    def exit(self):
        self.delete = messagebox.askyesno('QUẢN LÝ NHÀ HÀNG', 'BẠN CÓ MUỐN THOÁT?')
        if self.delete == True:
            self.cuaso.destroy()
    ...
    def Hoadon(self):
        ...
        self.ten_mon_an = Label(self.hoadon, text = 'Tên món', font = ('Arial Bold', 18))
        self.ten_mon_an.grid(row = 3, column = 0)

        self.so_luong_mon_an = Label(self.hoadon, text = 'Số lượng', font = ('Arial Bold', 18))
        self.so_luong_mon_an.grid(row = 3, column = 1)

        self.tong_tien_mon_an = Label(self.hoadon, text = 'Tổng tiền', font = ('Arial Bold', 18))
        self.tong_tien_mon_an.grid(row = 27, column = 0)

        self.tong_tien_do_an = Label(self.hoadon, text = 'Tổng', font = ('Arial Bold', 18))
        self.tong_tien_do_an.grid(row = 3, column = 2)

        self.vat_hoa_don = Label(self.hoadon, text = 'VAT', font = ('Arial Bold', 18))
